...
const Homepage = () => {
  ...
  return (
    <div className='min-h-[100vh]'>
        <div className="flex items-center mx-auto mdx:flex-col w-[80%] min-h-[10vh] justify-between">
        ...
        <div className="w-[80%] min-h-[80vh] flex mx-auto ">
            <div className="min-h-[70vh] flex flex-col justify-center">
                <h2 className='text-[2.2rem] my-[1.2rem] lg:text-[1.7rem] mdx:text-[1.5rem] '>Feel less stressful and <span className='text-default-red'>keep in mind</span> everything</h2>
            ...
            <div className="flex flex-col mdx:hidden min-w-[400px] justify-center">
